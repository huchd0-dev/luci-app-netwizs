...
### ⚡ 极致的无感体验
* **智能 WAN 口协议检测与切换：** WAN 口识别网线的物理插拔状态，系统智能适配，完美过滤由拨号失败、软件重启引起的“假性掉线” **（拔除网线间隔十秒再接入WAN 口，协议智能自动检测切换机制启用）**。
...
* **一键开启ipv6：** 一键直连 IPv6 网络： 告别晦涩难懂的 DHCPv6、SLAAC 和中继设置。只需轻轻一点，系统即可自动智能下发 IPv6 地址，无缝拥抱下一代网络。
