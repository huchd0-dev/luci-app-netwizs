...
**NetWiz**网络设置向导-极简，开箱即用，是一款逻辑严谨缜密，搭载企业级Lan口防失联机制，WAN口上网方式智能切换（间隔10秒接入WAN口启动），智能防错校验，智能WiFi满血释放（无硬件时自动隐藏）、一键开启IPV6、智能IP、网关、WAN口、Lan口冲突排雷，全方位的守护，极致的无感体验，大屏小屏体验行云流水、观感丝滑。
...
* **兼容众多品牌硬件：** 物理网卡画像与多维探针调度机制，智能适配多芯片频段硬件，最大化挖掘硬件性能，满血释放WiFi信号，轻松解锁多路 5G/6G 并发，让多芯片硬件轻松成为“多路并发”的高端路由器。
...
* **一键开启路由器间WiFi的无缝切换：** 只要通过一键开启无缝漫游。用户无需专业技术，仅需满足两项条件即可快速完成多路由器间WiFi的自动“丝滑”跳转功能：WiFi名称、密码一致，设备处于同一局域网。
 （注意：环境中请勿存在多个 DHCP 服务；若路由器摆放距离较近，建议错开信道，避免同频信号互相干扰。）
