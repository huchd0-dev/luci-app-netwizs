...
* **Smart Concurrency Radar (LAN Auto-Defuse):** The 120-second rollback bomb uses `netstat` to count concurrent connections, accurately distinguishing true browser access (Conns ≥ 5) from background IoT probes to prevent false-positive defusals.
