...
return view.extend({
    ...
    render: function () {
        ...
        var htmlTemplate = [
            ...
            '.nw-version-tag { position: absolute; top: 0; right: -90px; background: rgba(15, 23, 42, 0.1); color: #f8fafc; font-size: 14px; font-weight: 600; padding: 5px 12px; border-radius: 6px; opacity: 0; pointer-events: none; transition: all 0.25s ease; font-family: monospace; z-index: 50; box-shadow: 0 4px 15px rgba(0,0,0,0.15); white-space: nowrap; border: 1px solid rgba(255,255,255,0.1); }',
            '.nw-title-wrap:hover .nw-version-tag { opacity: 1; top: -10px; }',
