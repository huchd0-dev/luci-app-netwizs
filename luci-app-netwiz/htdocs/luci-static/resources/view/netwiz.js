...
return view.extend({
    ...
    render: function () {
        ...
        var htmlTemplate = [
            ...
            '      <div style="display:flex; justify-content:space-between; align-items:center; padding:15px 20px; background:#0f172a;">',
            ...
            '            <span id="wisp-modal-close" class="nw-pointer" style="font-size:40px; cursor:pointer; color:#94a3b8; line-height:1;">&times;</span>',
            '         </div>',
            '      </div>',
